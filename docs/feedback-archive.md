...
Raw notes from `FEEDBACK.md`, moved here verbatim when they were triaged into tasks.
...
Only human notes land here. What the agent notices goes to `docs/agent-findings.md`.
