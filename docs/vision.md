...
Date: 2026-07-28
Supersedes: `docs/goals/initial-prototype/` (Rust/egui, archived at tag `rust-prototype`)
Stack decision: `docs/path-forward.md`
...
terminal. See [`docs/goals/zd-terminal/`](goals/zd-terminal/initial_thoughts.md).
...
| F14 feedback ledger not being closed | process — replaced by `FEEDBACK.md`, see `path-forward.md` |
