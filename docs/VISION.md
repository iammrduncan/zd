...
The application ships Light, Dark, Dracula, and Homebrew through the same loader.
System/light/dark choice, warmth, typography, Focus, wrapping, region geometry,
