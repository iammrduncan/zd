...
- [ ] support threadd mode (open project via threadd backend - (Stealth project))
- [ ] support init (On execute, adds npx skill add for proper skills, sets up agent.md, project scaffolding, etc).
- [ ] kanban style tasks for agent with text + attached screenshots etc.
