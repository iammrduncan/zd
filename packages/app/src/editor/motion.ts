...
/** Keyboard motion coordinated with editor focus and layout correction. */
 ...
 * chord lives in the workbench registry — see the note on `settledMotion` below for the line
