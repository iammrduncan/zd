...
import { scrollBoxTo, type ScrollMotion } from "./focus/scroll";
 ...
 *
 * §7.3 allows exactly one scroller and styles/markdown.css gives it to `.md-surface`.
 * The same lookup focus/index.ts makes, and for the same reason: CodeMirror's own
